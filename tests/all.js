        ...
        models.multicolour_user
          ...
          .exec(() => {
            server.inject({
                ...
                test.equal(response.statusCode, 200, "Response is 200 with valid session user."))
            ...
            server.inject({
                ...
                test.equal(response.statusCode, 400, "Response is 400 with missing 'Bearer' in authorization header."))
            ...
            server.inject({
                ...
                test.equal(response.statusCode, 401, "Response is 401 with an invalid authorization header prefix."))
            ...
            server.inject({
                ...
                test.equal(response.statusCode, 401, "Response is 401 with an invalid session token."))
          })
        })
  })
})