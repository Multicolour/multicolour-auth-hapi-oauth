                  ...
                  if (err) {
                      ...
                      if (err) {
                        ...
                        sessions.create({
                          ...
                          if (err) {
                            ...
                            sessions.find(session).populate("user").exec(session, (err, out) => {
                              if (err) {
                                reply[host.request("decorator")](Boom.wrap(err), sessions)
                              }
                              else {
                                reply[host.request("decorator")](out, sessions)
                              }
                            })
                          }
                        })
                    ...
                    sessions.create({
                      ...
                      if (err) {
                        ...
                        sessions.find(session).populate("user").exec((err, out) => {
                          if (err) {
                            reply[host.request("decorator")](Boom.wrap(err), sessions)
                          }
                          else {
